...
### Breaking Changes
- In order to avoid name collisions with `Microsoft.AspNetCore.Http.IResult` the namespace has been renamed to `WTorricos.Either`.
...
## Upgrade guide
- Update all your using statements to reference `WTorricos.Either` instead of the `Results` namespace.
